...
import {
  ...
  setPassword,
  reset,
} from "../../Redux/states/signupSlice";
import { useSignupMutation } from "../../Redux/apiState/signuapi";
import { toast } from "react-toastify";

function SignUp() {
  const dispatch = useDispatch();
  const { name, email, password, change } = useSelector(
  ...
  const Data = useSelector((state) => state.signupState);
        ...
        <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12 relative z-10">
          <div className="max-w-lg">
            ...
            <p className="text-xl text-gray-300 mb-12 font-light leading-relaxed">
              Transform your freelance business with AI-powered tools trusted by
              127K+ professionals worldwide.
            </p>
            ...
            <div className="mt-12 p-8 glass-premium rounded-3xl border border-white/10">
              <div className="text-center">
                ...
                <div className="text-gray-400 text-sm font-semibold">
                  Revenue Generated by Our Users
                </div>
              </div>
            </div>
          </div>
